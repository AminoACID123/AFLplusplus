...
libaflbluetooth.so: src/bluetooth/bt-fuzz.cpp src/bluetooth/BTFuzzState.cpp src/bluetooth/bt-harness.cpp src/bluetooth/bt-stack-analyze.cpp src/bluetooth/cJSON.c
