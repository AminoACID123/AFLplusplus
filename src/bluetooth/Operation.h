...
struct Parameter
{
    ...
    Parameter(){}
    Parameter(string _name, s32 _bytes):name(_name), bytes(_bytes){}
...
struct Operation
{
    ...
    Operation() {}
    Operation(string _name, bool _isCore): name(_name), isCore(_isCore){}
};
...
#define CORE_PARAMETER_SECURITY_LEVEL           "gap_security_level_t"
#define CORE_PARAMETER_SECURITY_LEVEL_SIZE      1
