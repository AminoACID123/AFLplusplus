...
void send_initial_packets(){
    ...
    u8 packet3[254]   =   {0x0E, 0xFC, 0x01, 0x14, 0x0c, 0x00, 'F', 'U', 'Z', 'Z'};
    u8 packet4[70]    =   {0x0E, 0x44, 0x01, 0x02, 0x10, 0x00};
    memset(packet4 + 6, 0xFF, 64);
    u8 packet5[]      =   {0x0E, 0x0a, 0x01, 0x09, 0x10, 0x00, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa};
    u8 packet6[]      =   {0x0E, 0x0B, 0x01, 0x05, 0x10, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
    u8 packet7[]      =   {0x0E, 0x0c, 0x01, 0x03, 0x10, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
    u8 packet8[]      =   {0x0E, 0x04, 0x01, 0x01, 0x0c, 0x00};
    u8 packet9[]      =   {0x0E, 0x04, 0x01, 0x63, 0x0c, 0x00};
    u8 packet10[]     =   {0x0E, 0x0a, 0x01, 0x60, 0x20, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
    u8 packet11[]     =   {0x0E, 0x04, 0x01, 0x6d, 0x0c, 0x00};
    u8 packet12[]     =   {0x0E, 0x04, 0x01, 0x01, 0x20, 0x00};
    u8 packet13[]     =   {0x0E, 0x0c, 0x01, 0x2f, 0x20, 0x00, 0xFB, 0x00, 0x90, 0x42, 0xFB, 0x00, 0x90, 0x42};
    u8 packet14[]     =   {0x0E, 0x04, 0x01, 0x24, 0x20, 0x00};
    u8 packet15[]     =   {0x0E, 0x05, 0x01, 0x0f, 0x20, 0x00, 0xff};
    u8 packet16[]     =   {0x0E, 0x06, 0x01, 0x3a, 0x20, 0x00, 0x72, 0x06};
    u8 packet17[]     =   {0x0E, 0x04, 0x01, 0x41, 0x20, 0x00};
    u8 packet18[]     =   {0x0E, 0x0c, 0x01, 0x18, 0x20, 0x00, 0xB8, 0x4E, 0x75, 0xC7, 0xE2, 0xBE, 0x8E, 0xAA};
    u8 packet19[]     =   {0x0E, 0x0c, 0x01, 0x18, 0x20, 0x00, 0xC6, 0x28, 0x81, 0xA5, 0xB9, 0xB1, 0x59, 0xFE};
    u8 packet20[]     =   {0x0E, 0x0c, 0x01, 0x18, 0x20, 0x00, 0x39, 0x77, 0x84, 0x1C, 0x29, 0x33, 0xEF, 0xF6};
    u8 packet21[]     =   {0x0E, 0x0c, 0x01, 0x18, 0x20, 0x00, 0x08, 0x4A, 0x6F, 0x0D, 0x19, 0xE4, 0x23, 0x0A}; 
    u8 packet22[]     =   {0x0E, 0x04, 0x01, 0x2d, 0x20, 0x00};
    u8 packet23[]     =   {0x0E, 0x05, 0x01, 0x2a, 0x20, 0x00, 0xFF};
    u8 packet24[]     =   {0x0E, 0x04, 0x01, 0x29, 0x20, 0x00};
